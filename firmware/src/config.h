...
// WiFi Configuration
// ==========================================
#define WIFI_SSID         "Shieon"  // Replace with your WiFi SSID
#define WIFI_PASSWORD     "1234515R"  // Replace with your WiFi password
...
#define MQ6_RO_CLEAN_AIR    3101.2  // Sensor resistance ratio in clean air (calibrate this value)
#define MQ6_ADC_MAX         4095  // ESP32 ADC is 12-bit (0–4095)
#define MQ6_VCC             3.3   // ESP32 ADC reference voltage
#define MQ6_VCC_SENSOR      5.0   // MQ-6 sensor is powered by 5V rail
